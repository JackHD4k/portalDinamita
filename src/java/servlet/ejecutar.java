...
public class ejecutar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            EntityManager em = Persistence.createEntityManagerFactory("LoginWebPU").createEntityManager();
            ...
            String tabla = request.getParameter("tablasuscripcion");
            modelo.Usuario usuario = new modelo.Usuario();

            EntityManagerFactory emf;
            emf = Persistence.createEntityManagerFactory("portalDinamita");
